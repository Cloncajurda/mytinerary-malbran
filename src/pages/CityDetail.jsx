...
import DetailCity from "../components/DetailCity.jsx";
...
import Itinerary from "../components/CityItineraries";
      ...
      <main>
          ...
          <section ref={itineraryRef} className="space-y-8 mb-8 text-neutral-500 dark:text-neutral-300">
              ...
              <div className="flex flex-wrap justify-center gap-4 xs:gap-16">
                  <FeatureDetailedCard title={`Currency: ${city.currency}`} src="../img/png/currency.png" className="dark:border-sky-500 dark:shadow-sky-500 from-sky-500/50 via-sky-400 to-sky-200" />
                  ...
                  <FeatureDetailedCard title={`Language: ${city.language}`} src="../img/png/language.png" className="dark:border-fuchsia-400 dark:shadow-fuchsia-500 bg-gradient-to-tr from-fuchsia-500/60 via-fuchsia-400 to-fuchsia-300" />
              </div>
